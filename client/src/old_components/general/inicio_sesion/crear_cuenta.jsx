...
export function FormCrearCuenta({ onSubmit, register, errors }) {
  return (
    <div className="col-6">
      ...
      >
        ...
        <div className="col-6 mb-2">
          ...
          />
          {errors.apellidop && (
            <p className="text-danger">Apellido paterno es requerido</p>
          )}
        </div>
        <div className="col-6 mb-2">
          ...
          />
          {errors.apellidom && (
            <p className="text-danger">Apellido materno es requerido</p>
          )}
        </div>
        <div className="col-6 mb-2">
        ...
        <div className="col-6 mb-2">
          ...
          {errors.genero && (
            <p className="text-danger">Por favor, selecciona un género</p>
          )}
        </div>
        <div className="col-6 mb-2">
